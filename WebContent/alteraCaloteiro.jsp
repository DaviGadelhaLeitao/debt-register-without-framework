			...
			<div>
				...
				<input type="hidden" name="id" value="${caloteiro.id}"/>
					<div class="form-group">
						...
						<input type="text" class="form-control" id="nome" name="nome" value="${caloteiro.nome}" required>
					</div>
					<div class="form-group">
						<label for="email">Email:</label>
						<input type="text" class="form-control" id="email" name="email" value="${caloteiro.email}" required>
					</div>
					<div class="form-group">
						<label for="devendo">Devendo R$:</label>
						<input type="text" class="form-control" id="devendo" name="devendo" value="${caloteiro.devendo}" required>
					</div>
					<div class="form-group">
						<label for="dataDivida">Data:</label>
						<input type="text" class="form-control" id="dataDivida" name="dataDivida" value="<fmt:formatDate value="${caloteiro.dataDivida.time}" pattern="dd/MM/yyyy"/>" required>
					</div>
